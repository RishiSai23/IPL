...
FILES = [
    "Ker_Smat_TopOrder.json",
    "Ker_Smat_MiddleOrder.json",
    "Ker_Smat_Finisher.json"
    
]

OUTPUT_FILE = DATA_DIR / "kl_smat_batters_ready.json"
...
print(f"✅ Exported {len(final_players)} Kerala SMAT batters")
